...
const TRANSLATIONS = [
  ...
  { id: 'net',  label: 'NET',  name: 'New English Translation' },
]
...
async function fetchPassage(transId, passageRef) {
  const res = await fetch(
    `/api/passage?trans=${encodeURIComponent(transId)}&ref=${encodeURIComponent(passageRef)}`
  )
